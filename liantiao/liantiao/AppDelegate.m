...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [NSURLProtocol registerClass:[HybridURLProtocol class]];
...
//    @property (nullable, readonly, copy) NSString *relativePath;
    ...
    NSLog(@"host = %@,port = %@,user = %@,password = %@,path = %@,fragment = %@,parameterString = %@,query = %@,relativePath = %@",url.host,url.port,url.user,url.password,url.path,url.fragment,url.parameterString,url.query,url.relativePath);
